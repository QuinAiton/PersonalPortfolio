...
const defaultState = {
	texts: [
		<div className={Styles.icons}>
			<p>React</p>
			<Image width={50} height={50} src={'/icons/react-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Docker</p>
			<Image width={50} height={50} src={'/icons/docker-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className="icon ">
			<p>NextJs</p>
			<Image width={50} height={50} src={'/icons/nextjs-svgrepo-com(1).svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>NodeJs</p>
			<Image width={50} height={50} src={'/icons/node-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Css</p>
			<Image width={50} height={50} src={'/icons/css-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>AWS</p>
			<Image width={50} height={50} src={'/icons/aws-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Javascript</p>
			<Image width={50} height={50} src={'/icons/js-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Html</p>
			<Image width={50} height={50} src={'/icons/html-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Python</p>
			<Image width={50} height={50} src={'/icons/py-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Tailwind</p>
			<Image width={50} height={50} src={'/icons/tailwind-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Ruby on Rails</p>
			<Image width={50} height={50} src={'/icons/rails-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
		<div className={Styles.icons}>
			<p>Typescript</p>
			<Image width={50} height={50} src={'/icons/typescript-svgrepo-com.svg'} alt={'Skill Image'} />
		</div>,
	],
	maxSpeed: 4,
	initialSpeed: 32,
